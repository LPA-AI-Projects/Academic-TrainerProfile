    ...
    "professional_experience_sections": [
        {
            ...
            "bullets": [
                "string (bullet 1 of 2 per block: one sentence ending in a period; target 85–115 chars for at most 2 printed lines; hard max 130 chars)",
                "string (bullet 2 of 2 per block: same one-sentence / two-line discipline)",
            ],
        }
    ],
    ...
    *,
    ...
    base_rules = [
        ...
        *(
        ...
        "professional_experience_sections bullets — substance: each sentence stays advisory and impact-oriented (capability uplift, standards, facilitation, learning design, change enablement)—not employment tasks or org-specific claims.",
        "professional_experience_sections bullets — two lines maximum (critical): the brochure prints each bullet in a narrow column (~11.5px Helvetica-style, ~440–460px of text width after the round bullet). Each bullet string MUST occupy at most two printed lines. A third wrapped line is a failure—shorten and rewrite until it fits.",
        "professional_experience_sections bullets — how to hit two lines: use exactly one crisp sentence per bullet (one period). Prefer about 14–22 words. Target roughly 85–115 characters per bullet; hard maximum 130 characters including spaces. Avoid long comma chains, em dashes stacked with clauses, semicolon lists, acronyms strung together, and multiple conjunctions that force a third line.",
        "professional_experience_sections bullets — split detail across the pair: put the first idea in bullet 1 and a complementary idea in bullet 2 instead of cramming both into one long bullet.",
        "professional_experience_sections bullets — display policy: full text is shown (no ellipsis or CSS trimming). If wording is too long, the section collides with the page layout—so treat the 85–115 character target as mandatory, 130 as an absolute ceiling.",
        "professional_experience_sections: each title at most 100 characters; each bullet at most 130 characters. Set professional_experience to an empty array [].",
